class IdentificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @identification.save
        drivers_license = ProcessOCR.process_image(@identification.driver.path)
        logger.info drivers_license
        if !drivers_license.nil? then
          @identification.license_number = drivers_license
          @identification.save 
        end
  ...
  private
    ...
    def identification_params
      params.require(:identification).permit(:user_id, :license_number,:driver)
